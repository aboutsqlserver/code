...
select top 50
	...
	,qs.total_rows as [Total Rows] -- SQL Server 2008+
	,qs.last_rows as [Last Rows] -- SQL Server 2008+
	,qs.min_rows as [Min Rows] -- SQL Server 2008+
	,qs.max_rows as [Max Rows] -- SQL Server 2008+ 
from 
