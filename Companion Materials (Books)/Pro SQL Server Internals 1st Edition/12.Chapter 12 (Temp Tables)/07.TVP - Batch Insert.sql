...
/****************************************************************************/
/*    This script prepares database structure for XXX application */
/**/
/****************************************************************************/
...
if exists(
	...
	where 
		p.name = 'InsertDataRecordsTVP' and s.name = 'dbo'
)
	drop proc dbo.InsertDataRecordsTVP
go
...
if exists(
	...
	from sys.procedures p join sys.schemas s on 
		p.schema_id = s.schema_id
	where 
		p.name = 'InsertDataRecordsElementsXml' and s.name = 'dbo' 
)
	drop proc dbo.InsertDataRecordsElementsXml
go
...
if exists(
	...
	from sys.procedures p join sys.schemas s on 
		p.schema_id = s.schema_id
	where 
		p.name = 'InsertDataRecordsAttrXml' and s.name = 'dbo'
)
	drop proc dbo.InsertDataRecordsAttrXml
go
...
if exists(
	...
	from sys.procedures p join sys.schemas s on 
		p.schema_id = s.schema_id
	where 
		p.name = 'InsertDataRecordsOpenXML' and s.name = 'dbo'
)
	drop proc dbo.InsertDataRecordsOpenXML
go
...
if exists(
	...
	from sys.procedures p join sys.schemas s on 
		p.schema_id = s.schema_id
	where 
		s.name = 'dbo' and p.name = 'InsertDataRecordsAttrXml2'
)
	drop proc dbo.InsertDataRecordsAttrXml2
go
...
if exists(
	...
	where 
		t.name = 'DataRecordsTVP' and s.name = 'dbo' 
)
	drop type dbo.DataRecordsTVP
go
...
(
	...
	from sys.tables t join sys.schemas s on
		t.schema_id = s.schema_id
	where
		s.name = 'dbo' and t.name = 'DataRecords'    
)
