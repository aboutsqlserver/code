...
(
	...
	where
		s.name = 'dbo' and t.name = 'XmlDemo'    
)
	drop table dbo.XmlDemo
go
...
(
	...
	from sys.tables t join sys.schemas s on
		t.schema_id = s.schema_id
	where
		s.name = 'dbo' and t.name = 'XmlTypedDemo'    
)
	drop table dbo.XmlTypedDemo
go
...
(
	...
	where
		s.name = 'dbo' and c.name = 'XmlDemoCollection'    
)
	drop xml schema collection dbo.XmlDemoCollection
go
