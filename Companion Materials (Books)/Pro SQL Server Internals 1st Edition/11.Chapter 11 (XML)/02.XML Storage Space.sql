...
(
	...
	where
		s.name = 'dbo' and t.name = 'ElementCentricUntyped'    
)
	drop table dbo.ElementCentricUntyped
go
...
(
	...
	from sys.tables t join sys.schemas s on
		t.schema_id = s.schema_id
	where
		s.name = 'dbo' and t.name = 'ElementCentricTyped'    
)
	drop table dbo.ElementCentricTyped
go
...
(
	...
	from sys.tables t join sys.schemas s on
		t.schema_id = s.schema_id
	where
		s.name = 'dbo' and t.name = 'AttributeCentricUntyped'    
)
	drop table dbo.AttributeCentricUntyped
go
...
(
	...
	from sys.tables t join sys.schemas s on
		t.schema_id = s.schema_id
	where
		s.name = 'dbo' and t.name = 'AttributeCentricTyped'    
)
	drop table dbo.AttributeCentricTyped
go
...
(
	select * 
	from sys.xml_schema_collections c join sys.schemas s on
		c.schema_id = s.schema_id
	where
		s.name = 'dbo' and c.name = 'ElementCentricSchema'    
)
	drop xml schema collection dbo.ElementCentricSchema 
go
...
(
	...
	from sys.xml_schema_collections c join sys.schemas s on
		c.schema_id = s.schema_id
	where
		s.name = 'dbo' and c.name = 'AttributeCentricSchema'    
)
	drop xml schema collection dbo.AttributeCentricSchema 
go
