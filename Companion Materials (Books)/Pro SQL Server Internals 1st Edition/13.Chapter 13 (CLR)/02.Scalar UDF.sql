...
if object_id(N'dbo.EvenNumber','FN') is not null
	drop function dbo.EvenNumber
go

if object_id(N'dbo.EvenNumberInline','IF') is not null
	drop function dbo.EvenNumberInline
go
