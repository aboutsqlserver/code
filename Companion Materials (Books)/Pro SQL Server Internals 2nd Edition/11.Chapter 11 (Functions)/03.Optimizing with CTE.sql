...
if object_id(N'dbo.GetCornerPoints','TF') is not null drop function dbo.GetCornerPoints;
if object_id(N'dbo.GetCornerPointsInline','IF') is not null drop function dbo.GetCornerPointsInline;
