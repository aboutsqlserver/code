...
if exists(select * from sys.tables t join sys.schemas s on t.schema_id = s.schema_id where s.name = 'dbo' and t.name = 'UniqueCI') drop table dbo.UniqueCI;
if exists(select * from sys.tables t join sys.schemas s on t.schema_id = s.schema_id where s.name = 'dbo' and t.name = 'NonUniqueCINoDups') drop table dbo.NonUniqueCINoDups;
if exists(select * from sys.tables t join sys.schemas s on t.schema_id = s.schema_id where s.name = 'dbo' and t.name = 'NonUniqueCIDups') drop table dbo.NonUniqueCIDups;
go
