...
if exists(select * from sys.tables t join sys.schemas s on t.schema_id = s.schema_id where s.name = 'dbo' and t.name = 'IdentityCI') drop table dbo.IdentityCI;
if exists(select * from sys.tables t join sys.schemas s on t.schema_id = s.schema_id where s.name = 'dbo' and t.name = 'UniqueidentifierCI') drop table dbo.UniqueidentifierCI;
go
