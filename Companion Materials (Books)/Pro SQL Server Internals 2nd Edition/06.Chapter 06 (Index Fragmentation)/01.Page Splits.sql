...
if exists(select * from sys.tables t join sys.schemas s on t.schema_id = s.schema_id where s.name = 'dbo' and t.name = 'PageSplitDemo') drop table dbo.PageSplitDemo;
go
...
/*** You would get different results in SQL Server 2005-2008R2 and SQL Server 2012-2016 ***/
