...
/*                      Check Constraints Overhead                          */
/****************************************************************************/

use [SqlServerInternals]
go

if exists(select * from sys.tables t join sys.schemas s on t.schema_id = s.schema_id where s.name = 'dbo' and t.name = 'CheckConstraintTest') drop table dbo.CheckConstraintTest;
if (object_id(N'dbo.DummyCheck','FN') is not null) drop function dbo.DummyCheck;
go
