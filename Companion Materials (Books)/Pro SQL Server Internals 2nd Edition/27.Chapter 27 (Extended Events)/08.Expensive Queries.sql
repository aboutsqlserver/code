...
if exists(select * from sys.server_event_sessions where name = 'Expensive Queries') drop event session [Expensive Queries] on server;
go


/****************************************************************************/
/* rpc_completed event support is rather limited in SQL Server 2008/2008R2. */
/* SQL Profiler can provide you more information required for performance   */
/* troubleshooting.                                                         */
/****************************************************************************/
